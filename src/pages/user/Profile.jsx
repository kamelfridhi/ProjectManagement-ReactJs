                                        ...
                                        <div className="card-body d-flex teacher-fulldeatil">
                                            ...
                                            <div
                                                ...
                                                <p className="mt-2 small">
                                                    ...
                                                    block of text (sentence, paragraph, page, etc.) that doesnt
                                                ...
                                                <div className="row g-2 pt-2">
                                                    ...
                                                    <div className="col-xl-5">
                                                        <div className="d-flex align-items-center">
                                                            ...
                                                            <span
                                                                className="ms-2 small">{currentUser.dateOfBirth}</span>
                                                        </div>
                                                    </div>
                                                    <div className="col-xl-5">
                                                        <div className="d-flex align-items-center">
                                                            ...
                                                            <div className="dd-handle">
                                                                <div
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <span
                                                                            className="badge bg-warning text-end mt-1">
                              Inprogress
                            </span>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div className="dd-handle">
                                                                <div
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <span
                                                                            className="badge bg-success text-end mt-1">
                              Completed
                            </span>
                                                                    </div>
                                                                </div>
